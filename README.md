...
## IMERSÃO DADOS ALURA:  :white_check_mark:

- Cronograma de Início: 19/10/2020
- Cronograma de Término: 24/10/2020
...
- [ ] Cronograma - Início: 19/10/2020  (seg)
- [ ] Cronograma - Término: 24/10/2020 (sab)
- 5 aulas exclusivas e inéditas!
- De 19 a 24 de outubro, AULAS COMPLETAS E LIVES
- Trabalhe com os dados da educação do Brasil
- Crie um modelo de Machine Learning
...
## 1 Sua primeira Análise em Dados de Educação - #ImersaoDados
...
## 3 Distribuições e Correlações entre notas
...
## 5 Validação de modelo e Overfit
...
## LIVE - DataHackers, Storytelling e o Bootcamp Data Science Aplicada

## LIVE - Imersão Dados Live - Carreira no Exterior em Data Science

## LIVE - Imersão Dados Live - Dados da Educação Brasil e Carreira
